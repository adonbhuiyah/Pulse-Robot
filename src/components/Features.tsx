...
export const FeatureCard = ({
  ...
  return (
    <div
      ref={cardRef}
      className={cn(
        "feature-card glass-card p-4 opacity-0 sm:p-6",
        "lg:hover:bg-gradient-to-br lg:hover:from-white lg:hover:to-pulse-50",
        "transition-all duration-300",
      )}
      style={{ animationDelay: `${0.1 * index}s` }}
    >
      <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-full bg-pulse-50 text-pulse-500 sm:mb-5 sm:h-12 sm:w-12">
        {icon}
      </div>
    ...
    >
      <div className="section-container">
        <div className="mb-10 text-center sm:mb-16">
          <div className="pulse-chip fade-in-element mx-auto mb-3 opacity-0 sm:mb-4">
            <span>Features</span>
          </div>
          <h2 className="section-title fade-in-element mb-3 opacity-0 sm:mb-4">
            Advanced Intelligence, <br className="hidden sm:block" />
            Human-Like Intuition
          </h2>
          <p className="section-subtitle fade-in-element mx-auto opacity-0">
            Built with cutting-edge technology to understand, learn, and adapt
            to your unique needs.
          </p>
        </div>

        <div className="grid cursor-pointer grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6 md:gap-8 lg:grid-cols-3">
          <FeatureCard
            icon={
              <svg
                viewBox="0 0 24 24"
