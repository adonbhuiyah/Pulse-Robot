      ...
      >
        <div className="container mx-auto flex h-full flex-col px-6 lg:px-8">
          <div className="mb-2 md:mb-3">
            ...
            <h2 className="section-title mb-1 font-display text-3xl font-bold sm:text-4xl md:mb-2 md:text-5xl">
              Why Humanoid
            </h2>
          </div>
          ...
          >
            ...
            >
              ...
              <div className="relative z-10 flex h-full items-center p-5 sm:p-6 md:p-8">
                <div className="max-w-lg">
                  <h3 className="mb-4 font-display text-2xl font-bold leading-tight text-white sm:text-3xl md:text-4xl">
            ...
            >
              ...
              <div className="relative z-10 flex h-full items-center p-5 sm:p-6 md:p-8">
                <div className="max-w-lg">
                  <h3 className="mb-4 font-display text-2xl font-bold leading-tight text-white sm:text-3xl md:text-4xl">
                    We're creating companions,{" "}
                    <span className="text-[#FC4D0A]">not replacements</span>
                  </h3>
                </div>
              </div>
            </div>
